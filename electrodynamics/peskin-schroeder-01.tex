...
&= \int \frac{d^3p}{(2\pi)^3} \bra{\vect{x}} e^{-i(\vect{p}^2/2m)t} \ket{\vect{p}} \bra{\vect{p}}\ket{\vect{x}_0} \label{kg:nonrelativistic-02} \\
...
$$
\ket{\psi} =
\sum_{i\in\mathbb{N}} \bra{e_i}\ket{\psi} \ket{e_i}
$$
...
All this to say that to go from \ref{kg:nonrelativistic-01} to \ref{kg:nonrelativistic-02},
