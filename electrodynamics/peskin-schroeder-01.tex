...
$$
where $\vect{r} = |\vect{x} - \vect{x}_0|$ and $p = |\vect{p}|$.

From here we can do the angular integrals first,

\begin{align*}
\int d\Omega \, e^{ip\vect{r}\cos\theta} &= 
    \int_{0}^{2\pi} d\phi \int_{0}^{\pi} \sin\theta e^{ip\vect{r}\cos\theta} \\
&= 2\pi \int_{0}^{\pi} \sin\theta e^{ip\vect{r}\cos\theta} \\
&= -2\pi \int_{1}^{-1} du \, e^{ip\vect{r} u} \\
&= -2\pi \left( \frac{ e^{ip\vect{r} u} }{ ip\vect{r} } \right) \Big|_{u=1}^{u=-1} \\
&= -\frac{2\pi}{ip\vect{r}} \left( e^{-ip\vect{r}} - e^{ip\vect{r}} \right)
\end{align*}
...
\int d\Omega \, e^{ip\vect{r}\cos\theta} &= 
    -\frac{2\pi}{ip\vect{r}} \left( e^{-ip\vect{r}} - e^{ip\vect{r}} \right) \\
&= -\frac{2\pi}{ip\vect{r}} \left(-2i \sin(p\vect{r}) \right) \\
&= \frac{4\pi}{p\vect{r}} \sin(p\vect{r})
\end{align*}
...
\begin{align*}
\int \frac{dp}{(2\pi)^3} d\Omega \, |p|^2 e^{-it\sqrt{p^2 + m^2}} e^{ip\vect{r}\cos\theta} &=
\int \frac{dp}{(2\pi)^3} p \frac{4\pi}{\vect{r}} \sin(p\vect{r}) e^{-it\sqrt{p^2 + m^2}} \\
&= \frac{1}{2\pi^2 |\vect{x}-\vect{x}_0|}
